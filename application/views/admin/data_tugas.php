    ...
    <section class="section">
        <div class="">
            <div class="card" style="width:100%;">
                <div class="card-body">
                    <h2 class="card-title" style="color: black;">Management Data Tugas E-Module Statistika</h2>
                    <hr>
                    <p class="card-text"> Jumlah Tugas yang terdata di E-Module ini sekarang adalah 
                        <span class="font-weight-bold" style="color:black;">
                            <?php echo $this->db->count_all('el_tugas'); ?>
                         Tugas.</span>
                     Tugas dapat ditambah oleh admin.</p>
                    <a href="<?=base_url('admin/tambah_tugas')?>" class="btn btn-primary">Tambah Tugas</a>
                </div>
            </div>
        </div>
                    ...
                    <table id="example" class="table align-items-center table-flush">
                        ...
                        <tr class="text-center">
                            ...
                            <td class="text-center">
                                <a href="#" data-toggle="modal" data-target="#ModalMateri<?php echo $u->id; ?>" class="btn btn-success">Lihat Soal</a>
