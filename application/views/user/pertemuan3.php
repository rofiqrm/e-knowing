              ...
              <p><a href="<?=base_url('user/penyajian')?>">Kembali Ke Halaman Sebelumnya.</a></p>
                ...
                <p>Hello 
                    <?php
                        ...
                        echo $data['user']['nama'];
                        ?>!
                Materi yang akan kita pelajari pada pertemuan ketiga ini yaitu masih mengenai Ukuran Pemusatan Data yaitu :</p>
                <ol>
                  <li><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri14">Modus</a></li>
                  <li><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri15">Median</a></li>
                  <li><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri16">Kuartil</a></li>
                </ol>
        ...
        <div class="col-md-12">
            <div class="card komen w-150 border-0">
                <div class="card-body p-5" style="font-family: 'Poppins', sans-serif !important;">
                    ...
                    <br>
                    <br>
                    <a href="#" data-toggle="modal" data-target="#ModalMateri17">Download Rangkuman 3</a></li>
                    <p style="color: black !important;">Setelah menyaksikan video pembelajaran apakah anda dapat memahaminya?</p>
                    <p style="color: black; font-size: 20px !important;">Dengan cara yang sama dengan yang telah anda saksikan pada video pembelajaran, tentukanlah nilai Q3 Kemukakan jawaban anda di kolom komentar yaaa</p>
                    <br>
                    <?php echo $disqus ?>
                </div>
            </div>
...
<?php 
    ...
    <div class="container">
      <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;"> 
        <button class='btn btn-primary' data-toggle='modal' data-target='#show'>Latihan 2</button>
      </div>
    </div>
<?php     
  }
