              ...
              <p><a href="<?=base_url('user/penyajian')?>">Kembali Ke Halaman Sebelumnya.</a></p>
                ...
                <p>Hello 
                    <?php
                        ...
                        echo $data['user']['nama'];
                        ?>!
                Materi yang akan kita pelajari pada pertemuan kedua kali ini adalah sebagai berikut.</p>
                <p><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri9">UKURAN PEMUSATAN DATA</a></p>
                <p>1. Rata-Rata</p>
                <ol type="a">
                  <li><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri10">Rata-rata data tunggal</a></li>
                  <li><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri11">Rata-rata data berbobot</a></li>
                  <li><a style="color: blue;" href="#" data-toggle="modal" data-target="#ModalMateri12">Rata-rata data berkelompok</a></li>
                </ol>
        ...
        <div class="col-md-12">
            <div class="card komen w-150 border-0">
                <div class="card-body p-5" style="font-family: 'Poppins', sans-serif !important;">
                    ...
                    <br>
                    <br>
                    <a href="#" data-toggle="modal" data-target="#ModalMateri13">Download Rangkuman 2</a></li>
                    <p style="color: black !important;">Setelah menyaksikan video pembelajaran apakah anda dapat memahaminya?</p>
                    <p style="color: black; font-size: 20px !important;">Jika mahasiswa yang kehadirannya kurang dari rata-rata kelasnya harus mengikuti kuliah tambahan, ada berapa jumlah mahasiswa yang harus mengikuti kuliah tambahan tersebut?</p>
                    <p>Silahkan anda jawab di kolom komentar ya</p>
                    <br>
                    <?php echo $disqus ?>
                </div>
            </div>
...
<?php 
    ...
    <div class="container">
      <div class="bg-white mx-auto p-4 buat-text" data-aos="fade-down" data-aos-duration="1400" style="width: 100%; border-radius:10px;"> 
        <button class='btn btn-primary' data-toggle='modal' data-target='#show'>Latihan 1</button>
      </div>
    </div>
<?php     
  }
